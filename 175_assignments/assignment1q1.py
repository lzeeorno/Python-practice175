...
#https://stackoverflow.com/questions/19503460/how-do-you-write-to-a-new-line-when-writing-to-a-file-in-python
#https://www.youtube.com/watch?v=ruNJkD_3-fQ&feature=youtu.be
...
summary_file = open("as1q1_output.txt", "w")  #create a new file summary to write our result
...
summary_file.write("| Phone Number | Name                         | Due    |\n")           
summary_file.write("+--------------+------------------------------+--------+\n")
...
summary_file.write("+--------------+------------------------------+--------+\n")
summary_file.write("| Total Dues   |"+"{:>39}".format("$"+"{0:10.2f}".format(total_due))+"|\n")
summary_file.write("+--------------+------------------------------+--------+\n")        
